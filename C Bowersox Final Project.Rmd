...
splitsville <- sdf_partition(dfbeerrm2, train = 0.8, test = 0.2, seed = 1234)
...
```{r scoobys echo=FALSE, warning=FALSE}
#scoobybrew
...
df_user <- train_beer%>% filter(review_profilename == "*AleDrinkToTha")%>%
    select(review_overall,
           review_aroma,
           review_appearance,
           review_palate,
